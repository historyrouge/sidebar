...
exports.generateQuestionPaperTool = void 0;
...
async function generateQuestionPaper(input) {
    ...
    try {
        ...
        const validatedOutput = question_paper_types_1.GenerateQuestionPaperOutputSchema.parse(jsonResponse);
...
exports.generateQuestionPaperTool = genkit_1.ai.defineTool({
    ...
    inputSchema: question_paper_types_1.GenerateQuestionPaperInputSchema,
    outputSchema: question_paper_types_1.GenerateQuestionPaperOutputSchema,
}, async (input) => {
