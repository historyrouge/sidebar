...
const GenerateMindMapInputSchema = zod_1.z.object({
    content: zod_1.z.string().describe('The content to generate the mind map from.'),
});
const GenerateMindMapOutputSchema = zod_1.z.object({
    mindmapText: zod_1.z.string().describe('The generated mind map in ASCII text format.'),
});
