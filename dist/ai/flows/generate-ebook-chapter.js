...
exports.generateEbookChapter = generateEbookChapter;
/**
...
const GenerateEbookChapterInputSchema = zod_1.z.object({
    title: zod_1.z.string().describe('The title of the ebook.'),
    chapter: zod_1.z.number().describe('The chapter number to generate.'),
});
const ContentBlockSchema = zod_1.z.object({
    type: zod_1.z.enum(['h1', 'h2', 'p']).describe("The type of content block: h1 for chapter title, h2 for section title, p for paragraph."),
    text: zod_1.z.string().describe("The text content of the block."),
});
const GenerateEbookChapterOutputSchema = zod_1.z.object({
    content: zod_1.z.array(ContentBlockSchema).describe('An array of content blocks for the chapter.'),
});
...
`;
async function generateEbookChapter(input) {
