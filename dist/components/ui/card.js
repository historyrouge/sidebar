...
const Card = React.forwardRef(({ className, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, utils_1.cn)("rounded-lg border border-border/10 bg-card/5 text-card-foreground shadow-sm backdrop-blur-lg", className), ...props })));
exports.Card = Card;
