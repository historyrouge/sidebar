...
export function CreateFlashcardsContent() {
    ...
    const handleGenerateFlashcards = () => {
        ...
        startGenerating(async () => {
            // Flashcards are always generated by SambaNova now
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 h-full">
                    <Card className="flex flex-col">
                        ...
                        <CardDescription>Paste your study material below to create a set of flashcards using SambaNova.</CardDescription>
                        </CardHeader>
