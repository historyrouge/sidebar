...
import { FileUp, Loader2, Moon, Sun, Wand2, Save, Image as ImageIcon, X, Volume2, Pilcrow, CheckCircle2, Circle, Camera, BrainCircuit, HelpCircle, BookCopy, ListTree, Code, Copy, Mic, MicOff, MapPin, Calendar, Users, RotateCw } from "lucide-react";
                    ...
                    <div>
                         {videoDevices.length > 1 && (
                            <Button variant="outline" onClick={handleSwitchCamera}>
                                <RotateCw className="mr-2 h-4 w-4" /> Switch Camera
                            </Button>
                        )}
                    </div>
