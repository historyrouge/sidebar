...
export async function generateFlashcardsAction(
  ...
  try {
    // Flashcards are always generated by SambaNova
...
export async function generateQuizAction(
  ...
  try {
    // Quizzes are always generated by SambaNova
    const output = await generateQuizzesSamba(input, 'samba');
    return { data: output };
  } catch (e: any) {
    console.error(e);
    if (isRateLimitError(e)) return { error: "API_LIMIT_EXCEEDED" };
...
export async function chatWithTutorAction(
  ...
  try {
     // Tutor chat always uses SambaNova
...
export async function summarizeContentAction(
  ...
  try {
    // Summarization is always done by SambaNova
